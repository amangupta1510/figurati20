...
<div id="content" class="pmd-content content-area dashboard">
	...
	<div class="container-fluid full-width-container">
		...
		<ol class="breadcrumb text-left">
		  ...
		  <li class="active">Edit Distributer</li>
		</ol>
		<!--breadcrum end-->
	
		<div class="section"> 

			<form action="{{ route('admin-edit_distributer_submit') }}" method="post" enctype="multipart/form-data">
				@csrf
				...
				<div class="pmd-card-body">
					...
					<div class="group-fields clearfix row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="lead">EDIT DSTRIBUTER</div>
						</div>
					</div>
					...
					<div class="group-fields clearfix row">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group pmd-textfield">
								...
								<input type="text" name="name" id="name" class="form-control" value="{{$dt->name}}" placeholder="Distributer Name" required>
							</div>
						</div>
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group pmd-textfield">
								...
								<input type="number" name="contact" id="contact" class="form-control" value="{{$dt->contact}}" onblur="checkMobile(this.value)" placeholder="Contact" required>
							</div>
						</div>
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group pmd-textfield">
								...
								<input type="email" name="email" id="email" class="form-control" value="{{$dt->email}}"  placeholder="someone@example.com" maxlength="255" onblur="checkEmail(this.value)" required>
							</div>
						</div>
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group pmd-textfield">
								...
								<input type="text" name="address" id="address" class="form-control" value="{{$dt->address}}" placeholder="Distributer Address" required>
							</div>
						</div>
